...
func TestMasterOn(t *testing.T) {
	...
	assert.Nil(t, err)
	// assert.Contains(t, environment.Integration.Spec.Traits.Builder.Properties, "quarkus.camel.cluster.kubernetes.enabled=true")
	// assert.Contains(t, environment.Integration.Spec.Traits.Builder.Properties, "quarkus.camel.cluster.kubernetes.resource-name=test-lock")
	// assert.Contains(t, environment.Integration.Spec.Traits.Builder.Properties, "quarkus.camel.cluster.kubernetes.lease-resource-type=ConfigMap")
	// assert.Contains(t, environment.Integration.Spec.Traits.Builder.Properties, "quarkus.camel.cluster.kubernetes.labels.\"camel.apache.org/integration\"=test")
	// Running phase
