...
func (action *createAction) Handle(ctx context.Context, platform *v1.IntegrationPlatform) (*v1.IntegrationPlatform, error) {
	...
	catalog, err := action.loadCatalog(ctx, platform.Namespace, runtimeSpec)
	if err != nil {
		return nil, err
	}
...
func (action *createAction) loadCatalog(ctx context.Context, namespace string, runtimeSpec v1.RuntimeSpec) (*v1.CamelCatalog, error) {
	options := []k8sclient.ListOption{
		k8sclient.InNamespace(namespace),
	}
	list := v1.NewCamelCatalogList()
	if err := action.client.List(ctx, &list, options...); err != nil {
		return nil, err
	}
...
func (action *createAction) handleBundledCatalog(ctx context.Context, platform *v1.IntegrationPlatform, catalog *v1.CamelCatalog) (*v1.IntegrationPlatform, error) {
	...
	if catalog == nil {
		...
		camelVersion = cat.Spec.Runtime.Metadata["camel.version"]
	} else {
		camelVersion = catalog.Spec.Runtime.Metadata["camel.version"]
	}
